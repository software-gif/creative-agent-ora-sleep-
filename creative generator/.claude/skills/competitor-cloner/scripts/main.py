#!/usr/bin/env python3
"""Competitor Cloner — Generates brand versions of competitor ad designs.

Takes a competitor ad image as style reference and generates a new version
with brand product and benefits via Gemini image generation.
"""
...
PRODUCT: {product['name']} by {brand['name']}
...
BRAND STYLE:
- Use brand fonts and colors from brand guidelines
...
def main():
    parser = argparse.ArgumentParser(description="Competitor Cloner — Clone competitor ads with brand styling")
    ...
    parser.add_argument("--benefits", nargs="*", default=None, help="3 benefits (default: from brand.json)")
    ...
    # Headline
    headline = args.headline or f"{product['name']} — Jetzt entdecken"
